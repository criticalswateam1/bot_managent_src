    ...
    client.on('interactionCreate', async interaction => {
        if (!interaction.isButton()) return;
            if(interaction.message.channel.id == TicketChannelID || interaction.message.channel.id == OrderChannelID || interaction.message.channel.id == RecoverChannelId){
                interaction.reply({content: `<a:yes:1075484548005101691> **Ping Successful!** You can now Open a Ticket!`, ephemeral: true})
            }
    })
    client.on('interactionCreate', async interaction => {
        ...
        if (interaction.message.channel.id == TicketChannelID) {
            ...
            if(menuIndex){
                ...
                switch(menuIndex.type){
                    case "HELP" : {
                        await interaction.reply({content: `<:discord:1075487707356213289> Creating your Ticket ... `, ephemeral: true})
                    ...
                    > The <@&935689419757854780> will try to help you with your Bot Problem as soon as possible!`, "ticketsystem4.message");
                        ...
                        if(parentChannel.children.size >= 50) { parentId = overflowParents.find(c => c.children.size < 50); }
                         ...
                         guild.channels.create(channelname.substring(0, 32), {
                            ...
                            ch.send({content: `<@${user.id}> ➡ ${ticket.adminroles.map(r => `<@&${r}>`).join(" | ")} ${emoji.arrow_left}`, embeds: [ new MessageEmbed().setColor("#6861fe")
                            ...
                            new MessageEmbed().setColor("ORANGE").setTitle(`${emoji.loading}  A Staff Member will claim the Ticket soon!`).setDescription(`**Dear ${user}!**\n> This Ticket will be claimed by a Staff Member as soon as possible!\n\n> *He/She/They will help you then!*\n\n> **Meanwhile, make sure to list us all Information needed!**`).setFooter("Thanks for choosing Team Arcades Development ✌️", "https://cdn.discordapp.com/attachments/936372059305566219/964968487250436206/unknown.png")],
                        components: [
                            new MessageActionRow().addComponents([
                                new MessageButton().setStyle("SUCCESS").setLabel("Claim the Ticket").setEmoji(`<:discord:1075487707356213289>`).setCustomId("TicketClaim")
                            ])
                    ...
                    case "GENERAL" : {
                        ...
                        guild.channels.create(channelname.substring(0, 32), {
                            ...
                            client.setups.set(user.id, ch.id, "ticketid4");
                            client.setups.set(ch.id, user.id, "user");
                            ch.send({content: `<@${user.id}> ➡ ${ticket.adminroles.map(r => `<@&${r}>`).join(" | ")} ${emoji.arrow_left}`, embeds: [ new MessageEmbed().setColor("#6861fe").setTitle("📂 Thanks for opening a Ticket | What do you need?").setDescription(ticket.message.replace("{user}", `${user}`)),
                                new MessageEmbed().setColor("ORANGE").setTitle(`${emoji.loading}  A Staff Member will claim the Ticket soon!`).setDescription(`**Dear ${user}!**\n> This Ticket will be claimed by a Staff Member as soon as possible!\n\n> *He/She/They will help you then!*\n\n> **Meanwhile, make sure to list us all Information needed!**`).setFooter("Thanks for choosing Team Arcades Development ✌️", "https://cdn.discordapp.com/attachments/936372059305566219/964968487250436206/unknown.png")],
                            components: [
                                new MessageActionRow().addComponents([
                    ...
                    case "TEAMAPPLY" : {
                        ...
                        guild.channels.create(channelname.substring(0, 32), {
                            ...
                            client.setups.set(ch.id, user.id, "user");
                            ch.send({content: `<@${user.id}> ➡ ${ticket.adminroles.map(r => `<@&${r}>`).join(" | ")} ${emoji.arrow_left}`, embeds: [ new MessageEmbed().setColor("#6861fe").setTitle("📂 Thanks for opening an Application | Tell us something about you!").setDescription(ticket.message.replace("{user}", `${user}`)),
                                new MessageEmbed().setColor("ORANGE").setTitle(`${emoji.loading}  A Staff Member will claim the Ticket soon!`).setDescription(`**Dear ${user}!**\n> This Ticket will be claimed by a Staff Member as soon as possible!\n\n> *He/She/They will help you then!*\n\n> **Meanwhile, make sure to list us all Information needed!**`).setFooter("Thanks for choosing Team Arcades Development ✌️", "https://cdn.discordapp.com/attachments/936372059305566219/964968487250436206/unknown.png")],
                            components: [
                                new MessageActionRow().addComponents([
                                    new MessageButton().setStyle("PRIMARY").setLabel("Claim").setEmoji("📝").setCustomId("TicketClaim")
                    ...
                    case "PARTNERAPPLY" : {
                        ...
                        guild.channels.create(channelname.substring(0, 32), {
                            ...
                            client.setups.set(ch.id, user.id, "user");
                            ch.send({content: `<@${user.id}> ➡ ${ticket.adminroles.map(r => `<@&${r}>`).join(" | ")} ${emoji.arrow_left}`, embeds: [ new MessageEmbed().setColor("#6861fe").setTitle("📂 Thanks for opening an Partner-Application | Tell us something about you!").setDescription(ticket.message.replace("{user}", `${user}`)),
                                new MessageEmbed().setColor("ORANGE").setTitle(`${emoji.loading}  A Staff Member will claim the Ticket soon!`).setDescription(`**Dear ${user}!**\n> This Ticket will be claimed by a Staff Member as soon as possible!\n\n> *He/She/They will help you then!*\n\n> **Meanwhile, make sure to list us all Information needed!**`).setFooter("Thanks for choosing Team Arcades Development ✌️", "https://cdn.discordapp.com/attachments/936372059305566219/964968487250436206/unknown.png")],
                            components: [
                                new MessageActionRow().addComponents([
                                    new MessageButton().setStyle("PRIMARY").setLabel("Claim").setEmoji("📝").setCustomId("TicketClaim")
                    ...
                    case "CUSTOMBOT" : {
                        ...
                        await interaction.reply({content: `<:bot:1075488655700930641> Creating your Custom-Bot-Ordering-Ticket ... `, ephemeral: true})
                        ////////////////////////
                        /////////////////////////
                        ...
                        guild.channels.create(channelname.substring(0, 32), {
                            ...
                            client.setups.set(ch.id, user.id, "user");
                            ch.send({content: `<@${user.id}> ➡ ${ticket.adminroles.map(r => `<@&${r}>`).join(" | ")} ${emoji.arrow_left}`, embeds: [ new MessageEmbed().setColor("#6861fe").setTitle("📂 Thanks for ordering a Custom Bot!").setDescription(ticket.message.replace("{user}", `${user}`)),
                                new MessageEmbed().setColor("ORANGE").setTitle(`${emoji.loading}  A Staff Member will claim the Ticket soon!`).setDescription(`**Dear ${user}!**\n> This Ticket will be claimed by a Staff Member as soon as possible!\n\n> *He/She/They will help you then!*\n\n> **Meanwhile, make sure to list us all Information needed!**`).setFooter("Thanks for choosing Team Arcades Development ✌️", "https://cdn.discordapp.com/attachments/936372059305566219/964968487250436206/unknown.png")],
                            components: [
                                new MessageActionRow().addComponents([
                                    new MessageButton().setStyle("PRIMARY").setLabel("Claim").setEmoji("📝").setCustomId("TicketClaim")
                    ...
                    case "SOURCECODE" : {
                        await interaction.reply({content: `<a:develoment:1075486210883068044> Creating your Source-Code-Ordering-Ticket ... `, ephemeral: true})
                        ...
                        guild.channels.create(channelname.substring(0, 32), {
                            ...
                            client.setups.set(ch.id, user.id, "user");
                            ch.send({content: `<@${user.id}> ➡ ${ticket.adminroles.map(r => `<@&${r}>`).join(" | ")} ${emoji.arrow_left}`, embeds: [ new MessageEmbed().setColor("#6861fe").setTitle("📂 Thanks for ordering a Source Code!").setDescription(ticket.message.replace("{user}", `${user}`)),
                                new MessageEmbed().setColor("ORANGE").setTitle(`${emoji.loading}  A Staff Member will claim the Ticket soon!`).setDescription(`**Dear ${user}!**\n> This Ticket will be claimed by a Staff Member as soon as possible!\n\n> *He/She/They will help you then!*\n\n> **Meanwhile, make sure to list us all Information needed!**`).setFooter("Thanks for choosing Team Arcades Development ✌️", "https://cdn.discordapp.com/attachments/936372059305566219/964968487250436206/unknown.png")],
                            components: [
                                new MessageActionRow().addComponents([
                                    new MessageButton().setStyle("PRIMARY").setLabel("Claim").setEmoji("📝").setCustomId("TicketClaim")
