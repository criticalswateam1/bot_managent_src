...
module.exports = client => {
    var webConfig = {
        ...
        https: {
            enabled: true,
            Port: 443,
            key: "/etc/letsencrypt/live/pay.teamarcades.xyz/privkey.pem",
            cert: "/etc/letsencrypt/live/pay.teamarcades.xyz/fullchain.pem",
            chain: "/etc/letsencrypt/live/pay.teamarcades.xyz/chain.pem",
        },
        domain: `https://pay.teamarcades.xyz`,
