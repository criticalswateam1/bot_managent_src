...
module.exports = async (client) => {
    ...
    client.on('messageCreate', async message => {
        ...
        if (cmd == "nodestats") {
            const online = `<a:online:1075486861960679425>`;
            const offline = `❌`;
            const embed = new Discord.MessageEmbed()
                .setColor(client.config.color)
                .setAuthor("Team Arcades | Nodestats", message.guild.iconURL({
                    dynamic: true
                }), "https://status.teamarcades.xyz/")
            ...
            if (message.member.permissions.has("ADMINISTRATOR")) {
                let embed = new Discord.MessageEmbed()
                    .setTitle("Team Arcades | Ticket Support")
                    .setDescription(`This is the official [Team Arcades](https://teamarcades.xyz) ticket support.\n\nOptionally, you can contact us by email **support@teamarcades.xyz**`)
                    .setColor(client.config.color)
            ...
            if (message.member.permissions.has("ADMINISTRATOR")) {
                ...
                let embed = new Discord.MessageEmbed()
                    .setTitle("Team Arcades | Order")
                    .setDescription(`
➡ **Please take a Look at our [prices](https://discord.com/channels/1074767614108237905/1075477021456617483/944276114988220477) as well as at our [payment options](https://discord.com/channels/1074767614108237905/1075477021456617483/944952969961553970)**
...
➡  ***To open a Order-Ticket click on the Selection down below!***`)
                    .setDescription(`
If you want to buy a Bot from [Team Arcades](https://teamarcades.xyz) and you checked the [prices](https://discord.com/channels/1074767614108237905/1075477021456617483/944276114988220477) first, chose your wished bot in the drop-down menu down below.
\n***Available Bots are:***\n
> - **System Bot** 🤖
> 
> - **MusicBot** 🎵
...
> 
> - **Waitingroom Bot** 🕐
\nFor further questions about our pricing, please contact our marketing team at **marketing@teamarcades.xyz**`)
                    .setColor(client.config.color)
                let menuoptions = require("../settings.json").ordersystem;
                //define the selection
                let Selection = new MessageSelectMenu()
                ...
                let CheckPrices = new MessageButton().setStyle('LINK')
                    .setURL('https://discord.com/channels/1074767614108237905/1075477021456617483/944276114988220477')
                    .setLabel('Check the Prices')
                    .setEmoji(`<a:dinero:1075487970339078285>`);
         ...
         */
            ...
            if (message.member.roles.highest.rawPosition >= message.guild.roles.cache.get("1075477876335460513").rawPosition) {
                ...
                try {
                    ...
                    async function validate(result) {
                        return new Promise(async (res, rej) => {
                            ...
                            let button_delete = new MessageButton().setStyle('SUCCESS').setCustomId('validate_yes').setLabel("Yes, continue!").setEmoji(`<a:yes:1075484548005101691>`)
                    ...
                    async function areyousure(result) {
                        return new Promise(async (res, rej) => {
                            ...
                            let button_delete = new MessageButton().setStyle('SUCCESS').setCustomId('validate_yes').setLabel("Yes, create!").setEmoji(`<a:yes:1075484548005101691>`)
                            let qu_1 = await ch.send({
                                components: [new MessageActionRow().addComponents([button_close, button_delete])],
                     ...
                     */
                    if (owner.length < 17 || owner.length > 19) return ch.send("Invalid Owner ID, that would be a valid example: `313247783748501505`")
                    ...
                    if (token.length != "MTA2NTY2MjQzMTc3MjI4NzEyNw.GD3r0n.JdinM-OLs5BEdSS8Srv0h8PMZyYDN2-hAOinJE".length) return ch.send("INVALID TOKEN")
                    ...
                    if (!validurl) return ch.send("Not a Valid Image, That would be a valid image: `https://why.teamarcades.xyz/img/one.png`")
                    ...
                    if (!localhost) {
                        setTimeout(async () => {
                            ...
                            try {
                                ...
                                tempmsfg.embeds[0].fields[2].name = `<a:yes:1075484548005101691> ${localhost ? `Copying ${filenum} Files` : `Uploading ${filenum} Files to \`${serverId}\``}`
                                tempmsfg.embeds[0].fields[3].name = `<a:loading:1075485750000361523> Starting Bot...`
                                await tempmsfg.edit({
                                    embeds: [tempmsfg.embeds[0]]
                                }).catch(() => { });
                            ...
                            await fs.writeFile(`${process.cwd()}/servicebots/${BotDir}/template/tempbotconfig/config.json`, JSON.stringify(config, null, 3), async (e) => {
                                ...
                                tempmsfg.embeds[0].fields[0].name = `<a:yes:1075484548005101691> Changing Configuration Settings`
                            ...
                            await fs.writeFile(`${process.cwd()}/servicebots/${BotDir}/template/tempbotconfig/embed.json`, JSON.stringify(embed, null, 3), async (e) => {
                                ...
                                tempmsfg.embeds[0].fields[1].name = `<a:yes:1075484548005101691> Changing Embed Settings`
                                        ...
                                        stream.on('close', async (code, signal) => {
                                            ...
                                            setTimeout(() => {
                                                conn.exec("pm2 save", async (err, stream) => {
                                                    ...
                                                    stream.on('close', async (code, signal) => {
                                                        tempmsfg.embeds[0].fields[3].name = `<a:yes:1075484548005101691> Starting Bot...`
                                                        tempmsfg.embeds[0].fields[4].name = `<a:loading:1075485750000361523> Adding Finished Role`
                                                        conn.end();
                                                        resolve(true);
                                                    }).on('data', (data) => {
                            ...
                            try {
                                message.guild.members.fetch(owner).then(member => {
                                    ...
                                    if (member.roles.cache.has(`${mainconfig.FinishedOrderID}`)) {
                                        ...
                                        tempmsfg.embeds[0].fields[4].name = `<a:yes:1075484548005101691> Adding Finished Role & Removed recover Role`
                                        tempmsfg.embeds[0].fields[5].name = `<a:loading:1075485750000361523> Writing Database`
                                    } else {
                                        tempmsfg.embeds[0].fields[4].name = `<a:yes:1075484548005101691> Adding Finished Role`
                                        tempmsfg.embeds[0].fields[5].name = `<a:loading:1075485750000361523> Writing Database`
                                    }
                                })
                                await tempmsfg.edit({
                            ...
                            tempmsfg.embeds[0].fields[5].name = `<a:yes:1075484548005101691> Writing Database`
                            //get the botuser
            ...
            message.channel.send({
                components: [
                    new MessageActionRow().addComponents([
                        new MessageButton().setStyle("SUCCESS").setLabel("Close the Ticket").setCustomId("closeticket").setEmoji(`<a:yes:1075484548005101691>`),
                            ...
                            stream.on('close', (code, signal) => {
                                setTimeout(() => {
                                    sourcebin.create([{
                                        ...
                                        tmpmessage.edit(`<a:yes:1075484548005101691> **SUCCESSFULLY OUTPUT:**\n> ${haste.short ? haste.short : haste.url}`)
                                    }).catch(e => {
                ...
                try {
                    ...
                    if (!result || result.length < 1) {
                        ...
                        sourcebin.create([{
                            ...
                            tmpmessage.edit(`${result}\n\n> <a:yes:1075484548005101691> **COMPELETE OUTPUT:**\n> ${haste.short ? haste.short : haste.url}`)
                        }).catch(e => {
                        ...
                        sourcebin.create([{
                            ...
                            tmpmessage.edit(`<a:yes:1075484548005101691> **SEARCH SUCCESSFULL (LOOK ATTACHMENT)**\n\n> <a:yes:1075484548005101691> **SEARCH RESULT OUTPUT:**\n> ${haste.short ? haste.short : haste.url}`)
                        }).catch(e => {
                            // Handle error
                            tmpmessage.edit(`<a:yes:1075484548005101691> **SEARCH SUCCESSFULL (LOOK ATTACHMENT)**\n\n> ❌ \`\`\`js` + `${e.message ? e.message : e}`.substr(0, 1900) + `\`\`\``)
                            console.log(e.stack ? String(e.stack).grey : String(e).grey);
         ...
         */
            ...
            message.reply({
                embeds: [
                    new Discord.MessageEmbed()
                        ...
                        .setFooter("teamarcades.xyz | Order Free Bots NOW", "https://cdn.discordapp.com/attachments/936372059305566219/964968487250436206/unknown.png")
            ...
            if (args[0] && args.join(" ").toLowerCase().includes("cl")) {
                let messagelink = `https://discord.com/channels/1074767614108237905/912420703406526464/912422485222379620`;
                ...
                let messagelink = `https://discord.com/channels/1074767614108237905/912420703406526464/912422446106304562`;
                let channelId = messagelink.split("/")[5];
                let messageId = messagelink.split("/")[6];
                let Message = await message.channel.send(`<a:loading:1075485750000361523> **Getting Informations about:** ${messagelink}`)
                client.channels.fetch(channelId).then(channel => {
                ...
                let messagelink = `https://discord.com/channels/1074767614108237905/912420703406526464/912422375323230208`;
                let channelId = messagelink.split("/")[5];
                let messageId = messagelink.split("/")[6];
                let Message = await message.channel.send(`<a:loading:1075485750000361523> **Getting Informations about:** ${messagelink}`)
                client.channels.fetch(channelId).then(channel => {
                ...
                let messagelink = `https://discord.com/channels/1074767614108237905/912420703406526464/912422412249870346`;
                let channelId = messagelink.split("/")[5];
                let messageId = messagelink.split("/")[6];
                let Message = await message.channel.send(`<a:loading:1075485750000361523> **Getting Informations about:** ${messagelink}`)
                client.channels.fetch(channelId).then(channel => {
                ...
                let messagelink = `https://discord.com/channels/1074767614108237905/1075477021456617483/944276114988220477`;
                let channelId = messagelink.split("/")[5];
                let messageId = messagelink.split("/")[6];
                let Message = await message.channel.send(`<a:loading:1075485750000361523> **Getting Informations about:** ${messagelink}`)
                client.channels.fetch(channelId).then(channel => {
                ...
                message.reply({
                    ...
                    embeds: [
                        new Discord.MessageEmbed().setColor(client.config.color)
                            .setTitle(`Team Arcades Development | Get Free/Cheap Discord Bots for your needs!`)
                            ...
                            .setFooter(`Team Arcades Development | Order Today! Order Cheap!`, message.guild.iconURL({
                                dynamic: true
                            }))
                    ]
                })
         ...
         */
            ...
            // if (message.author.id !== `313247783748501505` || message.author.id !== `360693991110344717`) {
            ...
            try {
                ...
                message.channel.send({
                    embeds: [new Discord.MessageEmbed()
                        .setColor("WHITE")
                        .setTitle("Team Arcades Development | Evaluation")
