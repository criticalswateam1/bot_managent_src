...
module.exports = async (client) => {
    ...
    client.on("guildMemberAdd", member => {
        ...
        if (!member.user.bot) {
            try {
                welcomeChannel.send(`👋! ${member.user} welcome to **Team Arcades**`);
                member.send({
                    embeds: [new Discord.MessageEmbed()
                        ...
                        .setDescription(`
Welcome ${member.user} to <:discord:1075487707356213289>  [Team Arcades Development](https://teamarcades.xyz)<:discord:1075487707356213289>!
