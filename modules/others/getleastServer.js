...
module.exports = client => {
    ...
    const nodestatChannelID = "1075492109076922369";
    const nodestatMessageID = "1075492187728515102";
    ...
    async function getLeast() {
        ...
        client.channels.fetch(nodestatChannelID).then(channel => {
            channel.messages.fetch(nodestatMessageID).then(msg => {
                ...
                const offline = "<a:offline:1075488365010505819>";
                const embed = new Discord.MessageEmbed()
                    .setColor(client.config.color)
                    .setAuthor("Our Nodestats", msg.guild.iconURL({ dynamic: true }), "https://discord.gg/team-arcades-935157109761388554")
                    .setFooter("Team Arcades.dev | Order Bots NOW\nThis Message get's updated every 15 Minutes", "https://imgur.com/jPItIw0.gif")
