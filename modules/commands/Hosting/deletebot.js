...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        try {
            ...
            if (!bot || !bot.id) return message.channel.send("**❌ To Delete The Folder, Please Mention a Bot!**");
            ...
            collector.on("collect", (b) => {
                if (b.user.id !== message.author.id)
                    return b.reply({
                        content: `❌ **Only <@${message.author.id}> Allowed To React To This Message!**`,
                        ephemeral: true
                    })
                if (b.isButton()) {
