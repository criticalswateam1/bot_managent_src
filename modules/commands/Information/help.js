...
module.exports = {
    ...
    run: async (client, message, args, prefix) => {
        ...
        .setColor("GREEN")
        .setAuthor("Team Arcades | Free Bots Shop | Information Commands Help", message.guild.iconURL({dynamic: true}), "https://discord.gg/team-arcades-935157109761388554")
        ...
        .addField("\`,info wait/music/clan/etc.\`", "*Gives Information About the Bots, we offer*", true)
            //.addField("\u200b", "\u200b")
        .addField("\`,howtoorder\`", "*Shows how to order a BOT*\n*See the information in <#1075477021456617483> & <#1075477148061683732>!*", true)
            //.addField("\u200b", "\u200b")
        ...
        .addField("\`,modifybot\`", "Shows Info how to Change a CUSTOM BOT from <#1075477021456617483>*", true)
    ...
    var embed2 = new Discord.MessageEmbed()
        .setColor("YELLOW")
        .setAuthor("Team Arcades | Free Bots Shop | BOT CREATOR Help", message.guild.iconURL({dynamic: true}), "https://discord.gg/team-arcades-935157109761388554")
    ...
    var embed3 = new Discord.MessageEmbed()
        .setColor("RED")
        .setAuthor("Team Arcades | Free Bots Shop | Ticket Commands (STAFF Only)", message.guild.iconURL({dynamic: true}), "https://discord.gg/team-arcades-935157109761388554")
    ...
    var embed4 = new Discord.MessageEmbed()
        .setColor("ORANGE")
        .setAuthor("Team Arcades | Free Bots Shop | Higher Staff (Bot Management Commands)", message.guild.iconURL({dynamic: true}), "https://discord.gg/team-arcades-935157109761388554")
        ...
        .setColor("BLUE")
        .setAuthor("Team Arcades | Free Bots Shop | Other Setup Commands", message.guild.iconURL({dynamic: true}), "https://discord.gg/team-arcades-935157109761388554")
    ...
    var embed6 = new Discord.MessageEmbed()
        .setColor("WHITE")
        .setAuthor("Team Arcades | Free Bots Shop | Order Setup Commands", message.guild.iconURL({dynamic: true}), "https://discord.gg/team-arcades-935157109761388554")
